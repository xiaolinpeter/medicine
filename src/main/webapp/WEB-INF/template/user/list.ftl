				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<div class="modal-body">
							<div class="container-fluid">密码将被重置为123，确定重置密码？</div>
						</div>
						...
						<div class="modal-body">
							<div class="form-horizontal">
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<button id="setDefaultPwd" class="btn btn-success" onclick="document.getElementById('password').value=123">初始密码为123</button>										
									</div>
								</div>
								<div class="form-group">
...
<script>
	$(document).ready(function() {
		...
		$("button.btn-primary.btn-xs").click(function(){
			...
			var zNodes;
			$.ajax({
				url :  '${base}/admin/user/roleZtree?userId='+userid,
				type : 'get',
				async : false,
				success : function(result) {
					result = $.parseJSON(result);
		...
		function checkUsername(username) {
			$.ajax({
				url :  '${base}/admin/user/checkUsername',
				type : 'get',
				async : false,
				data : {
					'username' : username
		...
		function resetPassword(id){
			$.ajax({
				url :  '${base}/admin/user/updatepassword',
				data : {
					'userId' : id
				},
				type : 'POST',
